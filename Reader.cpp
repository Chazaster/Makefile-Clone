...
int Reader::isBlankOrComment (string &inputLine) {
...
void Reader::readNextNonBlankAndCommentLine (string &currentInputLine)
{
...
size_t Reader::idxOfFirstNonSpaceChar(string &line, size_t startIdx)
{
